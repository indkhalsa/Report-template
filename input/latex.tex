...
\includegraphics[scale=0.6]{images/latex.png}{\LaTeX{} Logo}
...
as \LaTeX.
\includegraphics[scale=0.6]{images/donald.jpg}{Donald Knuth, Inventor Of \TeX{} typesetting system}
...
\end{document}
\end{verbatim}
\includegraphics[scale=0.6]{images/latexoutput.png}
...
\begin{itemize}
\item {Texmaker}
\includegraphics[scale=0.6]{images/texmaker.png}{Texmaker, A Graphical \LaTeX{} Editor}
\item LEd
\includegraphics[scale=0.6]{images/led.png}{LEd, A Graphical \LaTeX{} Editor}
\end{itemize}
...
\end{document}
\end{verbatim}\\
\includegraphics[scale=0.6]{images/3d.png}{Graphics in \LaTeX{}}
...
\includegraphics[scale=0.6]{images/webgraphic.png}{Web based graphic generation using \LaTeX{}(input page)}s
